        ...
        for code in codes:
            ...
            for mp4 in mp4s:
                ...
                SAVE_DIR = os.path.join(
                    BASE_DIR, "processed_train", i, code, mp4.split(".")[0]
                )
                ...
                if cap.isOpened() == False:
                    ...
                    while cap.isOpened():
                        ...
                        if ret == True:
                            ...
                            mask = inference(net=net, img=frame, use_gpu=use_gpu)
                            ...
                            frame.save(os.path.join(SAVE_DIR, frame_filename))
                            mask.save(os.path.join(SAVE_DIR, mask_filename))
